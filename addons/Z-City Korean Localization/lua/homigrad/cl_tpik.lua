...
function hg.DoTPIK(ply, ent)
    ...
    if !ply_pelvis_matrix then return end
    ...
    if !ply_r_upperarm_matrix or !ply_r_forearm_matrix or !ply_r_hand_matrix or !ply_r_clavicle_matrix then return end
    ...
    if !ply_l_upperarm_matrix or !ply_l_forearm_matrix or !ply_l_hand_matrix or !ply_l_clavicle_matrix then return end
    ...
    if lerp_rh != 0 then
        ...
        if !segments or !segments[1] or !segments[2] or !segments[3] or !segments[1].Pos or !segments[2].Pos or !segments[3].Pos then return end
