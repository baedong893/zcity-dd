...
local BootStages = {
	[1] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[2] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[3] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("글로벌 시스템 점검:", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 2 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[4] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("글로벌 시스템 점검:", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 2 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("시각: 확인", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 3 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("촉각: 확인", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 4 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("청각: 확인", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 5 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("후각: 모듈을 찾을 수 없음", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("미각: 모듈을 찾을 수 없음", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[5] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("후각: 모듈을 찾을 수 없음", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("미각: 모듈을 찾을 수 없음", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("메모리 스캔: 진행 중", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[6] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("후각: 모듈을 찾을 수 없음", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("미각: 모듈을 찾을 수 없음", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("메모리 스캔: 진행 완료됨", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[7] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("미각: 모듈을 찾을 수 없음", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("메모리 스캔: 진행 완료됨", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("메모리 조정: 진행 중", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[8] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("미각: 모듈을 찾을 수 없음", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("메모리 스캔: 진행 완료됨", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("메모리 조정: 진행 완료됨", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[9] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("메모리 스캔: 진행 완료됨", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("메모리 조정: 진행 완료됨", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("의식 초기화 중...", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 10 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[10] = function(init2)
		draw.SimpleText("시스템 부팅 초기화", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS 버전: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("메모리 조정: 진행 완료됨", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("의식 초기화 중...", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 10 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("에코 \":3 한 하루 보내세요!\"", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 11 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
}
...
hook.Add("RenderScreenspaceEffects", "furload", function()
	if IsValid(hg.furload) and hg.furload.alpha != 255 then
		...
		draw.SimpleText(":3 한 하루 보내세요!", "ZB_ProotOSMedium", sw * 0.5 + 2, sh * 0.8 + 2, ColorAlpha(color_black, 255 * alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText(":3 한 하루 보내세요!", "ZB_ProotOSMedium", sw * 0.5, sh * 0.8, ColorAlpha(bluewhite, 255 * alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end)
