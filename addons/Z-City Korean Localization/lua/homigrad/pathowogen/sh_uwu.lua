...
properties.Add( "furrify", {
	MenuLabel = "퍼리 :3", -- Name to display on the context menu
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		hg.Furrify(ent)
		print(tostring(ply:Nick() or ply) .." 님이 ".. tostring(ent:Nick() or ent) .." 퍼리로 변경되었습니다. ")
	end
} )
...
if CLIENT then
	...
	hook.Add("RenderScreenspaceEffects", "furbot", function()
		...
		DrawTextAndShadow("시스템 상태: " .. Status, "ZB_ProotOSMedium", sw * 0.01, sh * 0.96, bluewhite, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
