...
SWEP.PrintName = "출혈 머스킷"
SWEP.Author = "N/A"
SWEP.Instructions = [[
이 머스킷은 실제로 혈액을 흘리는 것처럼 보입니다.

마우스 왼쪽 버튼을 길게 눌러 충전한 뒤 혈액 투사체를 발사하십시오.
발사 시 본인의 혈액 1000 또는 변종 혈액 2000이 소모됩니다. (합산 가능)

적중 시 대상에게 극심한 통증과 지남력 상실을 유발합니다.
고통을 느끼지 못하는 개체는 용해시킵니다.
방어구를 완전히 무시하며, 탄환의 관통력이 매우 높습니다.
