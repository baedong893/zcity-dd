...
SWEP.PrintName = "베타-차단제"
SWEP.Instructions = "베타-차단제는 스트레스 상황에서 공포 수치와 아드레날린 수치를 낮추는 데 도움을 줍니다. 적절한 용량을 투여하면 전투 상황에서 매우 유용합니다. 마우스 오른쪽 버튼(RMB)을 눌러 타인에게 주사할 수 있습니다."
