...
SWEP.Instructions = "글록(Glock)은 오스트리아의 총기 제조사 글록(Glock Ges.m.b.H.)이 설계 및 생산하는 폴리머 프레임 기반의 쇼트 리코일, 스트라이커 격발식, 폐쇄 노리쇠 방식 반자동 권총 브랜드입니다. 현재 모델은 9x19mm 탄환을 사용하는 글록 17(Glock 17) 버전입니다."
