...
SWEP.PrintName = "강철 갈고리"
SWEP.Instructions = "튼튼한 로프가 연결된 중량감 있는 강철 갈고리입니다. 높은 곳이나 먼 곳으로 이동하거나, 높은 지대에서 안전하게 하강할 때 사용하세요.\n\n마우스 왼쪽 버튼(LMB): 휘두르기/던지기\n마우스 왼쪽 버튼(LMB): 로프 팽팽하게 당기기\n마우스 왼쪽 버튼(LMB): 로프 감아 올리기\n마우스 오른쪽 버튼(RMB): 로프 풀기\nR 키: 로프 해제"
