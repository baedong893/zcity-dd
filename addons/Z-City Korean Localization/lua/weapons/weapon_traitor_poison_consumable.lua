...
SWEP.PrintName = "청강가리 캡슐"
SWEP.InstructionsBasic = "캡슐에 담긴 시안화칼륨 가루입니다.\n독성 (140mg 복용 시 무력화까지 약 90초 소요)\n단 음료와 함께 복용 시 시안화칼륨 성분이 분해될 수 있습니다.\n음식에 섞거나 붕대에 바르지 마십시오. 설마 이걸로 누군가를 죽이려는 건 아니겠죠?"	--; TODO Mansion tea cup
