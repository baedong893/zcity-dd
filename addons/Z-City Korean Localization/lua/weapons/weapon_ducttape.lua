...
SWEP.PrintName = "덕트 테이프"
SWEP.Instructions = "알루미늄 색상의 강화 방수 폴리에틸렌 코팅 비닐 천 덕트 테이프입니다. 물건들을 서로 붙이는 데 사용하세요.\n\n마우스 왼쪽 버튼(LMB)을 길게 눌러 점착.\n두 물체 사이의 이음새나 좁은 틈에만 테이프를 붙일 수 있습니다."
