...
SWEP.PrintName = "퓨리-13"
SWEP.Instructions = "퓨리-13(Fury-13)은 매우 강력한 각성제입니다. (전혀 관련 없는 수인화 바이러스 변종인 \"Furry-13\"과 혼동하지 마십시오.) 이 약물은 신체 기능을 단순히 '조절'하는 수준을 넘어, 인체에 추가적인 자원을 강제로 주입하여 이전과는 비교할 수 없는 힘을 끌어냅니다. 부작용으로 영구적인 뇌 손상이 발생할 수 있습니다. 감염자에게는 절대로 투여하지 마십시오."
