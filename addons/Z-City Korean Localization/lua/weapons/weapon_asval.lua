...
SWEP.Instructions = "1980년대 중반 소련 특수작전부대의 정수를 보여주는 강력한 병기입니다. 강철과 폴리머 재질로 제작된 AS VAL은 9x39mm 탄환을 사용하는 가스 작동식 선택 사격형 소총으로, 총열 일체형 소음기가 특징입니다.\n\n20발들이 탄창과 접이식 개머리판, 피스톨 그립을 갖추어 정밀도와 은밀함에 최적화되었습니다. 특히 아음속 탄환을 사용하여 총구 화염과 격발 소음을 속삭임 수준으로 억제합니다. 숙련된 사수의 손에서 '조용하지만 치명적인' 특수전의 효율성을 상징하는 무서운 무기가 됩니다.\n\n발사 속도: 분당 900발"
