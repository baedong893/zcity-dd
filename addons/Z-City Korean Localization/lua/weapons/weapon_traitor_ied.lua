...
SWEP.PrintName = "급조폭발물 (IED)"
SWEP.Instructions = "작은 골판지 상자에 담긴 수제 C4 폭탄입니다. 기폭 장치로는 오래된 노키아 휴대폰을 사용했습니다. 파편이나 화염 효과를 위해 폭탄을 다른 물체 안에 넣으십시오.\n\n마우스 왼쪽 버튼(LMB): 물체 안에 설치\n마우스 오른쪽 버튼(RMB): 그냥 설치\n설치 후 마우스 왼쪽 버튼(LMB): 기폭"
