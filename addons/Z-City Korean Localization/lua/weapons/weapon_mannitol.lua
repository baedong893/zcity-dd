...
SWEP.PrintName = "만니톨"
SWEP.Instructions = "만니톨은 두부 외상 후와 같이 급격히 상승한 뇌압을 낮추기 위해 정맥 주사로 투여하며, 확정적인 치료가 이루어지기 전까지 임시 조치로 사용됩니다. 중증 뇌 손상 후 뇌압 상승을 치료하는 주요 수단이지만, 1차 치료제로서 고장성 식염수(Hypertonic saline)보다 우월하지는 않습니다. 치료 저항성 사례에서는 고장성 식염수가 더 효과적입니다. 동맥 내 만니톨 주입은 밀착 연접(Tight junctions)을 일시적으로 파괴하여 혈뇌장벽(BBB)을 개방할 수 있습니다."
