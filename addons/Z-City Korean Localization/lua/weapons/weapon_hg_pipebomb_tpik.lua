...
SWEP.PrintName = "파이프 폭탄"
SWEP.Instructions = 
[[이 급조 폭발물(IED)은 흑색 화약을 채우고 주위를 못으로 감싼 두꺼운 강철 파이프로 제작되었습니다. 단순하고 짧은 도화선(Fuze)이 달려 있습니다. 이 장치는 저성능 폭약인 흑색 화약을 단단한 용기에 밀폐함으로써 높은 폭발 속도와 파편 비산 효과를 구현했습니다. 하지만 여전히 정식 수류탄만큼 치명적이거나 신뢰성이 높지는 않습니다.
