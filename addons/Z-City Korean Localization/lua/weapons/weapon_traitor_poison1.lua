...
SWEP.PrintName = "테트로도톡신 주사기"
SWEP.Instructions = "테트로도톡신은 1906년 일본인 과학자에 의해 발견된 강력한 독소입니다. 호흡근 마비로 인해 사망에 이르게 됩니다. 오직 척수 신경에만 주입할 수 있습니다."
...
if SERVER then
	...
	hook.Add("Org Think", "poison1",function(owner, org, timeValue)
		...
		if (not org.poison1notificate) and ((org.poison1 + 20) < curtime) then
			...
			org.owner:Notify("숨을 쉴 수가 없어....", true, "poison1", 3)
