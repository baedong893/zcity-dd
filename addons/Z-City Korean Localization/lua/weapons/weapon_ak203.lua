...
SWEP.Instructions = "소련 군사력의 결정체이자 강력한 위력을 지닌 7.62x39mm 소총입니다. 미하일 칼라시니코프가 설계한 이 AKM은 회전 노리쇠 방식과 가스 작동식 구조를 채택한 선택 사격식 화기이며, 반자동 및 자동 사격이 모두 가능합니다.\n\n분당 약 600발의 발사 속도와 10/20/30발들이 탈착식 탄창을 사용하며, 가혹한 환경에서도 변함없는 신뢰성을 보여줍니다. 현대전의 역사에 뚜렷한 족적을 남긴 이 화기는 소련의 기술적 진보를 상징하는 아이콘입니다."
