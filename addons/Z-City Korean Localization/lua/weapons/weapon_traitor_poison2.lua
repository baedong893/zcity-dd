...
SWEP.PrintName = "VX 바이알"
SWEP.Instructions = "VX는 유기인산염 화합물, 구체적으로는 티오포스포네이트 계열에 속하는 극독성 합성 화학 물질입니다. 신경 작용제 분류에 속하며, 살충제 연구 중 발견된 유기인산염의 독성을 바탕으로 화학전 용도의 군사적 목적으로 개발되었습니다."
...
if SERVER then
	...
	hook.Add("Org Think", "poison2",function(owner, org, timeValue)
		...
		if (not org.poison2notificate) and ((org.poison2 + 15) < CurTime()) then
			...
			org.owner:Notify("무언가 숨쉬는걸 방해하고 있어.", true, "poison2", 3)
