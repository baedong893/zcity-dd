...
SWEP.PrintName = "'우버' 노르에피네프린"
SWEP.Instructions = "출처가 불분명한 초기 퓨리-13(Fury-13) 샘플을 정제하여 만든 실험용 전투 자극제로, '퓨리-16'이라는 별칭으로 불립니다.\n\n신체를 직접 개조하는 대신, 모든 생체 자원을 강제로 연소시켜 폭발적인 속도 향상을 이끌어냅니다. 시스템에 합성 노르아드레날린을 대량 살포하여 극단적인 혈관 수축과 심박출량을 유도하는 방식으로 작동합니다."
