...
SWEP.Instructions = "AR-15 스타일 소총은 콜트 AR-15 설계를 기반으로 제작된 경량 반자동 소총입니다. 유진 스토너의 AR-10을 소형화했던 초기 아말라이트 AR-15에서 선택 사격(연사) 기능을 제거한 모델이며, 군용 M16 소총과 매우 밀접한 관련이 있습니다. 자신의 재산과 거처를 방어하기에 최적화된 화기입니다.\n\n사용 탄환: 5.56x45mm"
