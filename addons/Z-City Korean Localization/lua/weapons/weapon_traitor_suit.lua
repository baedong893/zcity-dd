...
SWEP.PrintName = "슈트"
SWEP.Instructions = "가면과 함께 구성된 간단한 복장으로, 신원을 숨기는 데 도움을 줍니다. 원래 입고 있던 옷은 가방 안에 보관되며, 나중에 언제든 다시 갈아입을 수 있습니다."
...
if CLIENT then
    ...
    function SWEP:OpenCostumeMenu()
        if self.IsCostumeActive then
            notification.AddLegacy("먼저 현재 착용 중인 코스튬을 벗어야 합니다!", NOTIFY_ERROR, 3)
