...
SWEP.Author = "FNH-USA"
SWEP.Instructions = "FN FNX 시리즈는 사우스캐롤라이나주 컬럼비아의 FN 아메리카(FNH USA)에서 제작한 폴리머 프레임 기반의 반자동 권총입니다. 이 시리즈는 9×19mm 파라벨럼, .40 S&W, .45 ACP 탄환을 사용하도록 설계되었으며, 현재 모델은 .45 ACP 탄환을 사용하는 버전입니다."--bruh too lazy to make .45 acp
