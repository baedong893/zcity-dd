...
SWEP.Instructions = "강철과 폴리머 재질로 제작된 5.56x45mm 구경의 AR-15 반자동 권총입니다. 소총의 법적 기준인 16인치보다 짧은 총열을 갖추고 있으며, 개머리판 대신 피스톨 버퍼 튜브나 스태빌라이징 브레이스를 장착하여 일반적인 소총보다 컴팩트하면서도 강력한 화력을 제공합니다.\n\n좁은 공간에서도 운용하기 용이한 크기이며, 뛰어난 범용성과 커스터마이징 편의성으로 민간 시장에서 독보적인 위치를 차지하고 있습니다. AR 플랫폼의 무궁무진한 확장성을 증명하는 이 모델은 자기 방어와 레저 사격 사이의 완벽한 균형을 상징합니다.\n\nALT+E를 눌러 파지법 변경 (걷기+사용 키)"
