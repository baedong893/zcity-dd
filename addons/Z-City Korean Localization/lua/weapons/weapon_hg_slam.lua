...
SWEP.Instructions = "선택형 경량 공격 탄약(Selectable Lightweight Attack Munition), 즉 M2/M3/M4 SLAM은 ATK Precision Fuze사가 생산하는 미국의 소형 다목적 지뢰입니다. 수동 적외선 센서와 자기 감응 센서가 장착되어 있어 파괴용 폭약, 측면 공격 지뢰(Off-route mine), 또는 차량 하부 전면 공격 지뢰로 사용할 수 있습니다."
SWEP.Spawnable = true
