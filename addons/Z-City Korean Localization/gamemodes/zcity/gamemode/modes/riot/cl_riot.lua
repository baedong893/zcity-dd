...
function MODE:HUDPaint()
    ...
    draw.SimpleText(T("mode_name_hmcd", "Homicide") .. " | " .. T("mode_name_riot", "Riot"), "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    local roleKey = team_ == 1 and "role_law_enforcement" or "role_rioter"
