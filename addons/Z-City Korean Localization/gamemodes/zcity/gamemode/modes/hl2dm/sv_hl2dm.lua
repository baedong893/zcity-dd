...
net.Receive("ZB_RequestAirStrike", function(len, ply)
	...
	if not ply:Alive() or ply:Team() ~= 1 or not ply.leader then return end
	if ply.organism and ply.organism.otrub then return end
	if (ply.ZBNextAirStrikeRequest or 0) > CurTime() then return end
	ply.ZBNextAirStrikeRequest = CurTime() + 0.5
