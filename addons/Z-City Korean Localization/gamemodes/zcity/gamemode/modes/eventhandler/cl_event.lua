...
function MODE:HUDPaint()
    ...
    local rawRoleName = isEventer and "Eventer" or GetGlobalString("ZB_EventRole","Player")
    local Rolename = T(ZCLang and ZCLang.RoleTextKeys and ZCLang.RoleTextKeys[rawRoleName] or "", rawRoleName)
...
local function CreateLootPollingMenu()
    ...
    LootPollingMenu.Paint= function(self, w, h)
        ...
        local text = "이벤트 전리품 설정 - " .. serverName
