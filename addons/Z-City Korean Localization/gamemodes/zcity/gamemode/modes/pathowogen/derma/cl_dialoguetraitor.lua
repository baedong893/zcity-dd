...
local text = "현재 작전 지역에 정체불명의 변종 바이러스(Pathowogen)가 창궐하고 있다. 추후 통지가 있을 때까지 해당 구역은 즉시 격리 조치되며, 그동안 너희를 탈출시킬 방법을 찾아보겠다."
...
function PANEL:Paint(w, h)
	...
	draw.GlowingText("계약자", "ZB_PathowogenDialogueTitle", w * 0.31, 0 - ScreenScale(1), ColorAlpha(red, 255), ColorAlpha(red, 235), ColorAlpha(red, 10), TEXT_ALIGN_LEFT)
