...
function PANEL:Paint(w, h)
	...
	DisableClipping(true)
        draw.SimpleText("상황 보고:", "ZB_UWUEnd2", w / 2 + 1, 0 - ScreenScale(10) + 1, shadow2, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        draw.GlowingText("상황 보고:", "ZB_UWUEnd2", w / 2, 0 - ScreenScale(10), ColorAlpha(red, 255), ColorAlpha(red, 235), ColorAlpha(red, 10), TEXT_ALIGN_CENTER)
